...
select readers.name as reader_name, books.title as book_title, borrowing.borrow_date 
from borrowing
join readers on borrowing.reader_id = readers.reader_id
join books on borrowing.book_id = books.book_id;

select books.title as book_title, books.author, categories.category_name 
from books
join categories on books.category_id = categories.category_id;

select readers.name as reader_name, fines.fine_amount, returning.return_date 
from fines
